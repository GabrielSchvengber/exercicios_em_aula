...
y1=float(input('Digite a coordenada x do ponto 1: '))

x2=float(input('Digite a coordenada x do ponto 2: '))
y2=float(input('Digite a coordenada x do ponto 2: '))

x3=float(input('Digite a coordenada x do ponto 3: '))
y3=float(input('Digite a coordenada x do ponto 3: '))
...
if l1<=abs(l2-l3) or l2<=(l1-l2) or l2<=(l1-l3):
    cond3=False
...
if cond1 == False or cond2==False or cond3==False:
    ...
    if cond3==False:
        print('Um dos lado é menor ou igual ao módulo da diferença!')
